            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active">Data_Nilai</li>
                    </ol>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT nilai.id, siswa.nama, mapel.nama_mapel, nilai.uts, nilai.uas, nilai.tugas, nilai.keterampilan
                                    FROM nilai
                                    INNER JOIN siswa ON siswa.nisn = nilai.nisn_siswa
                                    INNER JOIN mapel ON mapel.kode_mapel = nilai.kode_mapel;";
                                    $no = 1;
                                    $query = mysqli_query($connect, $sql);
                                    while ($data_nilai = mysqli_fetch_array($query)) {
                                    ?>
                                        <tr>
                                            <td><?= $data_nilai['nama'] ?></td>
                                            <td><?= $data_nilai['nama_mapel'] ?></td>
                                            <td><?= $data_nilai['tugas'] ?></td>
                                            <td><?= $data_nilai['uts'] ?></td>
                                            <td><?= $data_nilai['uas'] ?></td>
                                            <td><?= $data_nilai['keterampilan'] ?></td>
                                            <td><a type="submit" href="edit_nilai.php?id=<?= $data_nilai['id'] ?>" class="btn"><img src="../assets/user.png" width="25px" alt=""></a></td>
                                            <td> <a type="submit" href="../operation/delete.php?id=<?= $data_nilai['id'] ?>" class="btn"><img src="../assets/delete.png" width="25px" alt=""></a>
                                            </td>
                                        </tr>
                                    <?php
                                        $no++;
