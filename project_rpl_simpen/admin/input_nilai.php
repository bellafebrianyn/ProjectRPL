        ...
        <div class="main">
          <div class="mt-3 w-100 container">
            ...
            <div class="row container-fluid px4">
              <div class="col-6">
                <img src="../assets/nilai.png" height="400px" alt="klinik image" style="margin-left: 80px; margin-bottom: 60px; margin-top: 40px;">
                <div class="warning text-center" style="font-size: 15px;">
                </div>
              </div>
              <div class=" form-input col-6">
                <form method="POST" action="../operation/input_nilai_process.php">
                  <center class="mt-4">
                    ...
                    <div class="main-right row p-4">
                      ...
                      <div class=" mb-3">
                        <select class="dropdown-input form-select text-white font-weight-normal " name="dropdown_siswa" aria-label="Default select example">
                          ...
                          ?>
                            <option value="<?= $data_siswa['nisn'] ?>"><?= $data_siswa['nama'] ?> </option>
                          <?php
                          }
                          ?>
                        </select>
                      ...
                      <div class="mb-3">
                        <select class="dropdown-input form-select text-white font-weight-normal " name="dropdown_mapel" aria-label="Default select example">
                          ...
                          ?>
                            <option value="<?= $data_mapel['kode_mapel'] ?>"><?= $data_mapel['nama_mapel'] ?> </option>
                          <?php
                          }
                          ?>
                        </select>
                      ...
                      <div class="row mb-3">
                        <div class="col">
                          <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="UTS" name="uts">
                        </div>
                        <div class="col">
                          <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="UAS" name="uas">
                        </div>
                      </div>
                      <div class="row mb-3">
                        <div class="col">
                          <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="Tugas" name="tugas">
                        </div>
                        <div class="col">
                          <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="Keterampilan" name="keterampilan">
                        </div>
                      </div>
                      <div class="col mt-2">
