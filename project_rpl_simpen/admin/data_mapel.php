            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active">Data_MataPelajaran</li>
                    </ol>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT mapel.kode_mapel, mapel.nama_mapel, guru.nama
                                    FROM mapel
                                    INNER JOIN guru ON guru.nip = mapel.nip_guru;";
                                    $no = 1;
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a type="submit" href="edit_mapel.php?kode_mapel=<?= $data_mapel['kode_mapel'] ?>" class="btn"><img src="../assets/user.png" width="25px" alt=""></a></td>
                                            <td> <a type="submit" href="../operation/delete.php?kode_mapel=<?= $data_mapel['kode_mapel'] ?>" class="btn"><img src="../assets/delete.png" width="25px" alt=""></a>
                                            </td>
                                        </tr>
                                    <?php
                                        $no++;
