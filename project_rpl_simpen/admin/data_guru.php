            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active">Data_Guru</li>
                    </ol>
                    <div class="card mb-4">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a type="submit" href="edit_guru.php?nip=<?= $data_guru['nip'] ?>" class="btn"><img src="../assets/user.png" width="25px" alt=""></a></td>
                                            <td> <a type="submit" href="../operation/delete.php?nip=<?= $data_guru['nip'] ?>" class="btn"><img src="../assets/delete.png" width="25px" alt=""></a>
                                            </td>
                                        </tr>
                                    <?php
                                        $no++;
