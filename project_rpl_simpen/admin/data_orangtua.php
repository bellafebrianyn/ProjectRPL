            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active">Data_Orangtua</li>
                    </ol>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT orangtua.nama AS nama_ortu, orangtua.no_hp, orangtua.alamat, siswa.nama 
                                    FROM orangtua
                                    INNER JOIN siswa ON siswa.nisn = orangtua.nisn_siswa;";
                                    $no = 1;
                                    $query = mysqli_query($connect, $sql);
                                    while ($data_dokter = mysqli_fetch_array($query)) {
                                    ?>
                                        <tr>
                                            <td><?= $data_dokter['nama_ortu'] ?></td>
