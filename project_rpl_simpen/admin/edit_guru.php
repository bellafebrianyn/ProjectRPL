                ...
                <div class="main">
                    <div class="mt-3 w-100 container">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Input_Guru</li>
                        ...
                        <div class="row container-fluid px4">
                            ...
                            <div class=" form-input col-6">
                                <form method="POST" action="../operation/edit_guru_process.php">

                                    <center class="mt-4">
                                        <img src="../assets/checklist.png" width="50px" alt="">
                                        <a style="font-family: 'Poppins'; font-size:35px; color:white; font-weight:500;">Data Guru
                                            <hr size="2px" width="100%" color="white" />
                                        </a>

                                        <h5 class="mb-3" style="color: white; font-family: 'Poppins'; ">Edit Data Guru</h5>
                                        <?php
                                        ...
                                        <div class="main-right row p-4">
                                            <br>
                                            <div class="mb-3">
                                                <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="NIP" name="nip" value="<?= $data_guru['nip'] ?>" disabled>
                                            </div>

                                            <div class="mb-3">
                                                <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="Nama Lengkap" name="nama" value="<?= $data_guru['nama'] ?>">

                                            </div>
                                            <div class="mb-3">
                                                <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="No.HP" name="nohp" value="<?= $data_guru['no_hp'] ?>">
                                            </div>
                                            <div class="mb-3">
                                                <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="Alamat" name="alamat" value="<?= $data_guru['alamat'] ?>">
                                            </div>
                                            <div class="col mt-2">
