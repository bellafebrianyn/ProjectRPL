                ...
                <div class="main">
                    <div class="mt-3 w-100 container">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Input_Siwa</li>
                            <hr size="2px" width="100%" color="black" />
                        </ol>

                        <div class="row container-fluid px4">
                            <div class="col-5">
                                <img src="../assets/student.jpg" height="400px" alt="dokter image" style="margin-left: 90px; margin-top:60px;">
                                <div class="warning text-center" style="font-size: 15px;">
                                </div>
                            </div>
                            <div class=" form-input col-7">
                                <form method="POST" action="../operation/input_siswa_process.php">
                                    <center class="mt-4">
                                        <img src="../assets/checklist.png" width="50px" alt="">
                                        <a style="font-family: 'Poppins'; font-size:35px; color:white; font-weight:500;">Data Siswa
                                            <hr size="2px" width="100%" color="white" />
                                        </a>

                                        <h5 class="mb-3" style="color: white; font-family: 'Poppins'; ">Masukkan Data Siswa</h5>
                                        <div class="main-right row p-4">
                                            <br>
                                            <div class="col">
                                                <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="NISN" name="nisn">
                                            </div>
                                            <div class="col">
                                                <input type="text" class="form-control bg-transparent  text-white font-weight-normal" placeholder="NIS" name="nis">
                                            </div>
                                            <div>
                                                <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="Kelas" name="kelas">
                                            </div>
                                            <br>
                                            <div>
                                                <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="Alamat Siswa" name="alamat_siswa">

                                            </div>

                                            <div class=" col">
                                                <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="Nama Siswa" name="nama_siswa">
                                            </div>
                                            <div class=" col">
                                                <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="Nama Orangtua" name="nama_ortu">
                                            </div>
                                            <div class="row">
                                                <div class="col form-check">
                                                    <label class="form-check-label text-white" for="P">
                                                        <input class="form-check-input" type="radio" name="button_jk" id="P" value="P" checked>
                                                        P
                                                    </label>
                                                </div>
                                                <div class="col form-check">
                                                    <label class="form-check-label text-white" for="L">
                                                        <input class="form-check-input" type="radio" name="button_jk" id="L" value="L">
                                                        L
                                                    </label>
                                                </div>
                                            </div>
