                    ...
                    <div class="mt-3 w-100 container">
                        ...
                        <div class="row container-fluid px4">
                            ...
                            <div class=" form-input col-7">
                                <form method="POST" action="../operation/edit_siswa_process.php">
                                    <center class="mt-4">
                                        ...
                                        <div class="main-right row p-4">
                                            <br>
                                            <div class="col">
                                                <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="NISN" name="nisn" value="<?= $data_siswa['nisn'] ?>">
                                            </div>
                                            <div class="col">
                                                <input type="text" class="form-control bg-transparent  text-white font-weight-normal" placeholder="NIS" name="nis" value="<?= $data_siswa['nis'] ?>">
                                            </div>
                                            <div>
                                                <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="Kelas" name="kelas" value="<?= $data_siswa['kelas'] ?>">
                                            </div>
                                            <br>
                                            <div>
                                                <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="Alamat Siswa" name="alamat_siswa" value="<?= $data_siswa['alamat'] ?>">

                                            </div>

                                            <div class=" col">
                                                <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="Nama Siswa" name="nama_siswa" value="<?= $data_siswa['nama'] ?>">
                                            </div>
                                            <div class="row">
