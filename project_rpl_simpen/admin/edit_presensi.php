        ...
        <div class="main">
          <div class="mt-3 w-100 container">
            ...
            <ol class="breadcrumb mb-4">
              ...
              <li class="breadcrumb-item active">Input_Presensi</li>
            ...
            <div class="row container-fluid px4">
              ...
              <div class=" form-input col-6">
                <form method="POST" action="../operation/edit_presensi_process.php">
                  <center class="mt-4">
                    <img src="../assets/checklist.png" width="50px" alt="">
                    <a style="font-family: 'Poppins'; font-size:35px; color:white; font-weight:500;">Data Presensi
                      <hr size="2px" width="100%" color="white" />
                    </a>

                    <h5 class="mb-3" style="color: white; font-family: 'Poppins'; ">Edit Data Presensi</h5>
                    <?php
                    include '../connection/connection.php';
                    $id =  $_GET['id'];
                    $sql = "SELECT * FROM presensi WHERE id = '$id'";
                    $query = mysqli_query($connect, $sql);
                    $data_presensi = mysqli_fetch_array($query);
                    ?>
                    <input type="hidden" name="id" value="<?= $data_presensi['id'] ?>">

                    <div class="main-right row p-4">
                      <br>
                      <div class="mb-3">
                        <select class="dropdown-input form-select text-white font-weight-normal " name="dropdown_siswa" aria-label="Default select example" value="<?= $data_presensi['id'] ?>">
                          ...
                          ?>
                            <option value="<?= $data_siswaa['nisn'] ?>" <?= $data_presensi['nisn_siswa'] == $data_siswaa['nisn'] ? "selected" : ""; ?>><?= $data_siswaa['nama'] ?></option>
                          <?php
                          }
                          ?>
                        </select>
                      ...
                      <div class="mb-3">
                        <input type="number" class="form-control bg-transparent text-white font-weight-normal" placeholder="Jumlah Sakit" name="jml_sakit" value="<?= $data_presensi['jml_sakit'] ?>">
                      </div>
                      <div class="mb-3">
                        <input type="number" class="form-control bg-transparent text-white font-weight-normal" placeholder="Jumlah Alfa" name="jml_alfa" value="<?= $data_presensi['jml_alfa'] ?>">
                      </div>
                      <div class="mb-3">
                        <input type="number" class="form-control bg-transparent text-white font-weight-normal" placeholder="Jumlah Izin" name="jml_izin" value="<?= $data_presensi['jml_izin'] ?>">
                      </div>
                      <div class="col mt-2">
