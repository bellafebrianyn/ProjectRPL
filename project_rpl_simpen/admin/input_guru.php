        ...
        <div class="main">
          <div class="mt-3 w-100 container">
            ...
            <div class="row container-fluid px4">
              <div class="col-6">
                <img src="../assets/teacher.png" height="400px" alt="teacher image" style="margin-left: 80px; margin-bottom: 60px; margin-top: 40px;">
                <div class="warning text-center" style="font-size: 15px;">
                </div>
              </div>
              <div class=" form-input col-6">
                <form method="POST" action="../operation/input_guru_process.php">
                  <center class="mt-4">
                    ...
                    <h5 class="mb-3" style="color: white; font-family: 'Poppins'; ">Tambah Data Guru</h5>
                    <div class="main-right row p-4">
                      <br>
                      <div class="mb-3">
                        <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="NIP" name="nip">
                      </div>

                      <div class="mb-3">
                        <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="Nama Lengkap" name="nama">

                      </div>
                      <div class="mb-3">
                        <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="No.HP" name="nohp">
                      </div>
                      <div class="mb-3">
                        <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="Alamat" name="alamat">
                      </div>
                      <div class="col mt-2">
