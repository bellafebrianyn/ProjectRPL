        ...
        <div class="main">
          <div class="mt-3 w-100 container">
            ...
            <div class="row container-fluid px4">
              <div class="col-6">
                <img src="../assets/presensi.jpg" height="400px" alt="klinik image" style="margin-left: 80px; margin-bottom: 80px; margin-top: 40px;">
                <div class="warning text-center" style="font-size: 15px;">
                </div>
              </div>
              <div class=" form-input col-6">
                <form method="POST" action="../operation/input_presensi_process.php">
                  <center class="mt-4">
                    ...
                    <h5 class="mb-3" style="color: white; font-family: 'Poppins'; ">Tambah Data Presensi</h5>
                    <div class="main-right row p-4">
                      ...
                      <div class="mb-3">
                        <select class="dropdown-input form-select text-white font-weight-normal " name="dropdown_siswa" aria-label="Default select example">
                          ...
                          ?>
                            <option value="<?= $data_presensi['nisn'] ?>"><?= $data_presensi['nama'] ?></option>
                          <?php
                          }
                          ?>
                        </select>
                      </div>
                      <input type="hidden" value="<? $data_presensi['id'] ?>">
                      <div class="mb-3">
                        <input type="number" class="form-control bg-transparent text-white font-weight-normal" placeholder="Jumlah Sakit" name="jml_sakit">
                      </div>
                      <div class="mb-3">
                        <input type="number" class="form-control bg-transparent text-white font-weight-normal" placeholder="Jumlah Alfa" name="jml_alfa">
                      </div>
                      <div class="mb-3">
                        <input type="number" class="form-control bg-transparent text-white font-weight-normal" placeholder="Jumlah Izin" name="jml_izin">
                      </div>
                      <div class="col mt-2">
