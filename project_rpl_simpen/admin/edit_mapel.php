                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="input_guru.php">Mata Guru</a>
                            </nav>
                        </div>
                    ...
                    <div class="mt-3 w-100 container">
                        ...
                        <div class="row container-fluid px4">
                            ...
                            <div class=" form-input col-6">
                                <form method="POST" action="../operation/edit_mapel_process.php">
                                    <center class="mt-4">
                                        ...
                                        $data_mapel = mysqli_fetch_array($query);
                                        ?>
                                        ...
                                        <div class="main-right row p-4">
                                            <br>
                                            <div class="mb-3">
                                                <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="Kode Mata Pelajaran" name="kode_mapel" value="<?= $data_mapel['kode_mapel'] ?>" disabled>
                                            </div>
                                            <div class=" mb-3">
                                                <input type="text" class="form-control bg-transparent text-white font-weight-normal" placeholder="Nama Mata Pelajaran" name="nama_mapel" value="<?= $data_mapel['nama_mapel'] ?>">
                                            </div>
                                            <div class=" mb-3">
                                                <select class="dropdown-input form-select text-white font-weight-normal " name="dropdown_guru" aria-label="Default select example">
                                                    ...
                                                    ?>
                                                        <option value="<?= $data_guru['nip'] ?>" <?= $data_mapel['nip_guru']  == $data_guru['nip'] ? "selected" : ""; ?>><?= $data_guru['nama'] ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
